...
public class BuscarProductosF extends javax.swing.JInternalFrame {
    
    DefaultTableModel tabla;
    Conexion cc= new Conexion();
    Connection cn = cc.getConexion();
    
    public BuscarProductosF() {
        initComponents();
...
private void mnenviarproActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_mnenviarproActionPerformed
    try {
         DefaultTableModel tabladet = (DefaultTableModel) RegistrosFactura.tbdet.getModel();
        ...
        if(fila==-1){
         ...
         if((cant.equals("")) || (cant.equals("0"))){
            ...
            Object com=RegistrosFactura.tbdet.getValueAt(i,0);
            if(codins.equals(com)){
                j=i;
                RegistrosFactura.tbdet.setValueAt(cant, i, 3);
                c=c+1;
            }
          }
          if(c==0){
            ...
            RegistrosFactura.tbdet.setModel(tabladet);
                }
            }
