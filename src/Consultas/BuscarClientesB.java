...
public class BuscarClientesB extends javax.swing.JInternalFrame {
DefaultTableModel modelo;

    Conexion cc= new Conexion();
    Connection cn = cc.getConexion();
    
    public BuscarClientesB() {
        initComponents();
        mostrarclientes("");
...
private void mnenviarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_mnenviarActionPerformed
    ...
    try {
        ...
        RegistrosBoleta.txtcod.setText(cod);
        RegistrosBoleta.txtnomape.setText(nom+" "+ape);
        RegistrosBoleta.txtdire.setText(dir);
        RegistrosBoleta.txtdni.setText(dni);
